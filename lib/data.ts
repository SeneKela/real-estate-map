export const properties = [
  {
    ...
    description:
      "Résidence officielle du Président de la République française. Ce palais historique abrite les bureaux présidentiels et accueille les réceptions d'État.",
    installations: [
      "Salle de réception",
    ...
    bails: [
      {
        ...
        title: "FR-GOV-RE-PRESIDENCE-60 month Le Palais de l'Élysée Lease",
  ...
  },
  {
    ...
    description:
      "Résidence officielle et lieu de travail du Premier ministre français. Ce bâtiment historique abrite les services du Premier ministre et accueille les réunions gouvernementales.",
    installations: ["Bureaux administratifs", "Salle du Conseil", "Jardins", "Centre de presse", "Salles de réunion"],
    bails: [
      {
        reference: "MAT-2022-001",
        locataire: "Services du Premier Ministre",
        surface: 7500,
        loyer: 0, // Utilisation interne
  ...
  },
  {
    ...
    description:
      "Siège du ministère de l'Économie et des Finances, également connu sous le nom de Bercy. Ce complexe moderne abrite les services financiers de l'État.",
    installations: [
  ...
  },
  {
    ...
    description:
      "Prestigieuse université parisienne fondée au XIIIe siècle. Ce bâtiment historique est un centre d'excellence pour les lettres et sciences humaines.",
    installations: [
      "Amphithéâtres",
  ...
  },
  {
    ...
    description:
      "Ancienne résidence royale, le Château de Versailles est un chef-d'œuvre architectural et un symbole de l'art français du XVIIe siècle. Ce monument historique est aujourd'hui un musée national.",
    installations: [
    ...
    taches: [
      ...
      },
      {
        ...
        description:
          "Analyse des aménagements nécessaires pour améliorer l'accessibilité aux personnes à mobilité réduite.",
        priorite: "moyenne",
        assigneA: "Service Technique",
        echeance: "2024-01-31",
        statut: "Planifié",
